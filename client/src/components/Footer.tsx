...
export function Footer() {
  return (
    <footer className="mt-16 border-t bg-slate-50/50 py-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-sm text-muted-foreground">
                <Link href="/shipping">
                  <a className="hover:text-primary">Shipping Information</a>
                </Link>
              </li>
              <li className="text-sm text-muted-foreground">
                <Link href="/returns">
                  <a className="hover:text-primary">Returns & Exchanges</a>
                </Link>
              </li>
              <li className="text-sm text-muted-foreground">
                <Link href="/privacy">
